      ...
      <div className="input-field-container">
        <div className="input-field">
          ...
          <div className="input-wrapper">
            ...
            <input className="input-box" name="email" placeholder="Nguyen" />
          </div>
        
          <div className="input-wrapper">
            <label for="email">Last Name</label>
            <input className="input-box" name="email" placeholder="Van A" />
          </div>
        
          <div className="input-wrapper">
            <label for="email">Department</label>
            <input className="input-box" name="email" placeholder="Software Department" />
          </div>
